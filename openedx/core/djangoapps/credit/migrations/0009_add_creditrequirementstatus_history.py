...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoricalCreditRequirementStatus'
        db.create_table('credit_historicalcreditrequirementstatus', (
            ...
            ('reason', self.gf('jsonfield.fields.JSONField')(default={})),
            ('requirement', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'+', null=True, on_delete=models.DO_NOTHING, to=orm['credit.CreditRequirement'])),
        ...
        db.send_create_signal('credit', ['HistoricalCreditRequirementStatus'])

        # Adding unique constraint on 'CreditRequirementStatus', fields ['username', 'requirement']
        db.create_unique('credit_creditrequirementstatus', ['username', 'requirement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CreditRequirementStatus', fields ['username', 'requirement']
        db.delete_unique('credit_creditrequirementstatus', ['username', 'requirement_id'])

        # Deleting model 'HistoricalCreditRequirementStatus'
        db.delete_table('credit_historicalcreditrequirementstatus')
